...
(function (d) {
  ...
  "object" === typeof module
    ? d(require("knockout"), exports)
    : "function" === typeof define && define.amd
    ? define(["knockout", "exports"], d)
    : d(ko, (ko.mapping = {}));
})(function (d, f) {
  function y(b, c) {
    var a, e;
    for (e in c)
      if (c.hasOwnProperty(e) && c[e])
        if (
          ((a = f.getType(b[e])), e && b[e] && "array" !== a && "string" !== a)
        )
          y(b[e], c[e]);
        else if ("array" === f.getType(b[e]) && "array" === f.getType(c[e])) {
          a = b;
          for (
            var d = e, l = b[e], n = c[e], t = {}, g = l.length - 1;
            0 <= g;
            --g
          )
            t[l[g]] = l[g];
  ...
  function F(b, c, a, e, k, l, n) {
    ...
    var j = n || k,
      ...
      x = function (b) {
        ...
        b =
          d.utils.unwrapObservable(k) instanceof Array
            ? a[e].create({ data: b || c, parent: j, skip: N })
            : a[e].create({ data: b || c, parent: j });
    ...
    if (t) {
      ...
      a[e] &&
        a[e].arrayChanged &&
        d.utils.arrayForEach(t, function (b) {
      ...
      Q(c, function (e) {
        ...
        if (-1 == d.utils.arrayIndexOf(a.ignore, f))
          if (-1 != d.utils.arrayIndexOf(a.copy, f)) b[e] = c[e];
          else if (
            "object" != typeof c[e] &&
            "array" != typeof c[e] &&
            0 < a.observe.length &&
            -1 == d.utils.arrayIndexOf(a.observe, f)
          )
            ...
            if (
              ...
              if (d.isWriteableObservable(b[e]))
                ...
                (g = void 0 === b[e] ? g : d.utils.unwrapObservable(g)),
                  (b[e] = g);
  ...
  f.fromJS = function (b) {
    ...
    try {
      ...
      var c, a;
      2 == arguments.length &&
        (arguments[1][p] ? (a = arguments[1]) : (c = arguments[1]));
  ...
  f.visitModel = function (b, c, a) {
    ...
    Q(k, function (b) {
      if (!(a.ignore && -1 != d.utils.arrayIndexOf(a.ignore, b))) {
        ...
        if (
          !(
            -1 === d.utils.arrayIndexOf(a.copy, b) &&
            -1 === d.utils.arrayIndexOf(a.include, b) &&
            k[p] &&
            k[p].mappedProperties &&
            !k[p].mappedProperties[b] &&
            k[p].copiedProperties &&
            !k[p].copiedProperties[b] &&
            "array" !== f.getType(k)
          )
        )
