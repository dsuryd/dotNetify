...
dotnetify.react = {
  ...
  connect: function connect(iVMId, iReact, iOptions) {
    ...
    } else console.error('Component is attempting to connect to an already active \'' + iVMId + '\'. ' + ' If it\'s from a dismounted component, you must add vm.$destroy to componentWillUnmount().');
