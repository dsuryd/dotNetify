var TreeViewVM = (function () {
   return {
      isSelected: function (iItem) { return this.SelectedId() == iItem.Id() },
      expandIcon: function (iItem) { return iItem.Expanded() ? 'glyphicon-minus' : 'glyphicon-plus' },

      expand: function (iItem, iElement, iParentItem) {
         var vm = this;
         ...
         if (iItem.Children() == null) {
            ...
            vm.$preventBinding(function () { iItem.Expanded(!iItem.Expanded()) });
      }
   }
})();

require(['jquery'], function ($) {
   window.LinkedTreeViewVM = (function () {
      return $.extend(TreeViewVM, {
