...
var LiveChartVM = (function () {
    ...
    LiveChartVM.prototype.createChart = function (iItem, iElement) {
        ...
        return new Chart(iElement.getContext('2d'))
            .Line({
            labels: labels,
            datasets: [{ label: "", data: data, fillColor: "rgba(217,237,245,0.2)", strokeColor: "#9acfea", pointColor: "#9acfea", pointStrokeColor: "#fff" }]
